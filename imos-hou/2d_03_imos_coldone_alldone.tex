...
\begin{tikzpicture}
    ...
    \foreach \x / \y in {-2.5/1, -1.5/1, -0.5/1, 0.5/2, 1.5/1, 2.5/1, 3.5/0}
        \draw (\x, 1.5) node[debiru] {\textsf{\y}};
    \foreach \x / \y in {-2.5/1, -1.5/1, -0.5/1, 0.5/2, 1.5/1, 2.5/1, 3.5/0}
        \draw (\x, 0.5) node[debiru] {\textsf{\y}};
    \foreach \x / \y in {-2.5/1, -1.5/1, -0.5/2, 0.5/3, 1.5/2, 2.5/1, 3.5/0}
        \draw (\x, -0.5) node[debiru] {\textsf{\y}};
    \foreach \x / \y in {-2.5/0, -1.5/0, -0.5/1, 0.5/2, 1.5/2, 2.5/1, 3.5/0}
        \draw (\x, -1.5) node[debiru] {\textsf{\y}};
