...
\begin{tikzpicture}
    ...
    \draw[toko, very thick, dotted] (2, 1) -- (6, 1);
    \filldraw[toko, very thick] (2, 1) circle (1.2pt);
    \draw (2, 1) node[debiru, anchor=north] {\textsf{+1}};
    \filldraw[toko, very thick] (6, 1) circle (1.2pt);
    \draw (6, 1) node[debiru, anchor=north] {\textsf{-1}};
    
    \draw[gibara, very thick, dotted] (4, 2) -- (7, 2);
    \filldraw[gibara, very thick] (4, 2) circle (1.2pt);
    \draw (4, 2) node[debiru, anchor=north] {\textsf{+1}};
    \filldraw[gibara, very thick] (7, 2) circle (1.2pt);
    \draw (7, 2) node[debiru, anchor=north] {\textsf{-1}};
    
    \draw[warabeda, very thick, dotted] (1, 3) -- (8, 3);
    \filldraw[warabeda, very thick] (1, 3) circle (1.2pt);
    \draw (1, 3) node[debiru, anchor=north] {\textsf{+1}};
    \filldraw[warabeda, very thick] (8, 3) circle (1.2pt);
    \draw (8, 3) node[debiru, anchor=north] {\textsf{-1}};
    
    \draw[roa, very thick, dotted] (5, 4) -- (11, 4);
    \filldraw[roa, very thick] (5, 4) circle (1.2pt);
    \draw (5, 4) node[debiru, anchor=north] {\textsf{+1}};
    \filldraw[roa, very thick] (11, 4) circle (1.2pt);
    \draw (11, 4) node[debiru, anchor=north] {\textsf{-1}};
    
    \foreach[count=\x from 0] \y in {0, 1, 2, 2, 3, 4, 3, 2, 1, 1, 1, 0, 0}
        \draw (\x, -1) node[debiru] {\textsf{\y}};
